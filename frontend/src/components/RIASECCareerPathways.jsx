...
function RIASECCareerPathways({
  ...
  return (
    ...
    >
      ...
      <section>
        <h4 className="text-base font-bold text-slate-900 dark:text-slate-100 mb-2">RIASEC Fit (Great Fit)</h4>
      ...
      <section className="space-y-3">
        <h4 className="text-base font-bold text-slate-900 dark:text-slate-100">Great Fit Career Pathway</h4>
            ...
            <div className="rounded-2xl p-3">
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-3">
                  {(row.fields || []).slice(0, 3).map((field, fIdx) => (
                    <FieldCard
