  ...
  const loadAnalytics = async () => {
    try {
      ...
      setSectionScores([
        ...
        { section_number: 5, section_name: 'Realistic', score: 61 },
        { section_number: 6, section_name: 'Investigative', score: 58 },
        { section_number: 7, section_name: 'Artistic', score: 64 },
        { section_number: 8, section_name: 'Social', score: 70 },
        { section_number: 9, section_name: 'Enterprising', score: 55 },
        { section_number: 10, section_name: 'Conventional', score: 62 }
      ]);
    } catch (err) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          >
            ...
            {hasCareerData ? (
              ...
              <div style={{ width: '100%', height: '280px', minHeight: '280px' }} className="sm:h-[320px] flex items-center justify-center text-slate-400 dark:text-slate-500">
                <p className="text-xs sm:text-sm">No career cluster data available</p>
              </div>
            )}
          </motion.div>
        </div>
