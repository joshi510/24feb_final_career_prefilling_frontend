            ...
            {!timeUp && (
              timer.isPaused ? (
                <button
                  ...
                  className="px-3 py-1.5 text-xs font-medium bg-green-600 text-white rounded-lg hover:bg-green-700 active:scale-95 transition-all shadow-sm mt-1"
                >
                  Resume
                </button>
              ) : (
                <button
                  onClick={handlePause}
                  className="px-3 py-1.5 text-xs font-medium bg-amber-600 text-white rounded-lg hover:bg-amber-700 active:scale-95 transition-all shadow-sm mt-1"
                >
                  Pause
                </button>
              )
          ...
          <div className="flex justify-between">
            ...
            >
              ...
              <button
                ...
                className="px-4 py-1.5 text-sm bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-slate-800"
              >
                Next
              </button>
            ) : (
              <button
                ...
                className="px-4 py-1.5 text-sm bg-green-600 text-white rounded-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed hover:bg-green-700 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 dark:focus:ring-offset-slate-800 disabled:focus:ring-0"
              >
