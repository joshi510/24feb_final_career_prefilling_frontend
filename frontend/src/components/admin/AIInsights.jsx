  ...
  if (insights.length === 0) {
    return (
      <motion.div
        ...
        className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-4 sm:p-6"
      >
        ...
        {insights.map((insight, index) => {
          ...
          return (
            <motion.div
              ...
              className={`${styles.bg} ${styles.border} border rounded-lg p-3 sm:p-4`}
            >
              <div className="flex items-start gap-2 sm:gap-3">
                <div className={`${styles.icon} flex-shrink-0 mt-0.5`}>
                  <IconLightbulb className="w-4 h-4 sm:w-5 sm:h-5" />
                </div>
                <div className="flex-1 min-w-0">
                  <h4 className={`text-xs sm:text-sm font-semibold ${styles.title} mb-1.5 sm:mb-2`}>
                    {insight.title}
                  </h4>
