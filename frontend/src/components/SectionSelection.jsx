          ...
          return (
            ...
            >
              ...
              <div className="mt-2">
                ...
                {!unlocked && (
                  <div className="w-full py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg font-medium bg-slate-200 dark:bg-slate-700 text-slate-500 dark:text-slate-400 text-center cursor-not-allowed text-sm sm:text-base">
