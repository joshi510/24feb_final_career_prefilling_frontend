...
function SectionSelection({ onStartSection, attemptId, onStartTest, canAttemptTest = true }) {
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      {error && (
        <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg text-red-700 dark:text-red-400 text-sm">
          {error}
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        {sections.map((section, idx) => {
          ...
          // Show ALL 10 sections - sections 2-10 will be locked/disabled until previous is completed
          // Do NOT hide sections - show them all but lock sections 2-10
          ...
          return (
            <motion.div
              ...
              className={`relative rounded-xl p-4 sm:p-6 border-2 transition-all ${
                unlocked
                  ? isCompleted
            ...
            >
              ...
              <div className="mt-2">
                ...
                <div className="mb-4 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-xs sm:text-sm text-slate-600 dark:text-slate-400">
                ...
                {unlocked && (
                  <button
                    ...
                    className={`w-full py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg font-medium transition-all text-sm sm:text-base min-h-[44px] ${
                ...
                {!unlocked && (
                  <div className="w-full py-2.5 sm:py-3 px-3 sm:px-4 rounded-lg font-medium bg-slate-200 dark:bg-slate-700 text-slate-500 dark:text-slate-400 text-center cursor-not-allowed text-sm sm:text-base min-h-[44px] flex items-center justify-center">
